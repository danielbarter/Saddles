...
def wolfe_schlegel_test():
    ...
    minima_1 = find_minima(wolfe_schlegel, jnp.array([-1.5, 1.5]),
                           50000, 0.0001, test_dir + '/minima_1_report.pdf')

    minima_2 = find_minima(wolfe_schlegel, jnp.array([-1, -1.5]),
                           50000, 0.0001, test_dir + '/minima_2_report.pdf')


    minima_3 = find_minima(wolfe_schlegel, jnp.array([1.0, -1.5]),
                           50000, 0.0001, test_dir + '/minima_3_report.pdf')
    ...
    paths = find_geodesic(wolfe_schlegel, initial_points,
                          minima_1, minima_3, 60000, 0.00001, 100,
                          test_dir + '/geodesic_report.pdf'
                          )
